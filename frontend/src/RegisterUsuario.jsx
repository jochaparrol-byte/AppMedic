...
function RegisterUsuario() {
  const [nombresCompletos, setNombres]=useState("")
  const [apellidosCompletos, setApellidos]=useState("")
  ...
  const [parentescoCE, setParentescoCE]=useState("")
  ...
  const registroClick=()=>{
    console.log("se envio: ", nombresCompletos)
    const datosRegistro={
      nombres: nombresCompletos,
      apellidos: apellidosCompletos,
      tipodocumento: tipoDoucmento,
      numerodocumento: numeroDocumento ? parseInt(numeroDocumento, 10):0,
      fechadenacimiento: fechaNacimiento,
      sexo: tipoSexo,
      tipodesangre: tipoSangre,
      celular: telefonoCelular ? parseInt(telefonoCelular, 10):0,
      correo: correoElectronico,
      direccion: direccionResidencia,
      ocupacion: ocupacion,
      parentcontacto: parentescoCE,
      contactoemergencia:nombreCE,
      numerocontacto: numeroContacto ? parseInt(numeroContacto, 10):0,
      alergia: alergias,
      password: pass  
    }
    ...
    .then(datos=>setAlerta({
      apertura:true,
      mensaje:datos.nombrescompletos,
      severidad:"succes"
    }))
